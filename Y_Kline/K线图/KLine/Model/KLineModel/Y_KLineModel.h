 ...
 *  开盘价
 */
@property (nonatomic, copy) NSString *V_Open;

/**
 *  收盘价
 */
@property (nonatomic, copy) NSString *V_Close;

/**
 *  最高价
 */
@property (nonatomic, copy) NSString *V_High;

/**
 *  最低价
 */
@property (nonatomic, copy) NSString *V_Low;

/**
 *  成交量
 */
@property (nonatomic, copy) NSString *V_Volume;
...
//MA（7）=（C1+C2+……CN）/7
@property (nonatomic, strong) NSNumber *MA7;

//MA（30）=（C1+C2+……CN）/30
@property (nonatomic, strong) NSNumber *MA30;

@property (nonatomic, strong) NSNumber *MA12;

@property (nonatomic, strong) NSNumber *MA26;

@property (nonatomic, strong) NSNumber *Volume_MA7;

@property (nonatomic, strong) NSNumber *Volume_MA30;

@property (nonatomic, strong) NSNumber *Volume_EMA7;

@property (nonatomic, strong) NSNumber *Volume_EMA30;
...
@property (nonatomic, strong) NSNumber *BOLL_MD;

// n-1 天的 MA
@property (nonatomic, strong) NSNumber *BOLL_MB;

// MB + k * MD
@property (nonatomic, strong) NSNumber *BOLL_UP;

// MB - k * MD
@property (nonatomic, strong) NSNumber *BOLL_DN;

//  n 个 ( Cn - MA20)的平方和
@property (nonatomic, strong) NSNumber *BOLL_SUBMD_SUM;

// 当前的 ( Cn - MA20)的平方
@property (nonatomic, strong) NSNumber *BOLL_SUBMD;
...
@property (nonatomic, strong) NSNumber *NineClocksMinPrice;
...
@property (nonatomic, strong) NSNumber *NineClocksMaxPrice;
...
@property (nonatomic, strong) NSNumber *RSV_9;
